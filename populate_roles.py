...
['Finanzas','Rol para ver e ingresar movimientos contables, ver balance y reportes'],
['Historial','Rol para ver el log (historial) de las tablas (permite ver quien ha realizado cambios en las tablas)'],
['Aprobador','Rol para aprobar ingresos/egresos financieros'],
['Comite Etica','Rol Comision Etica'],
['Contador','Rol para manejar la contabilidad de las finanzas'],
]
