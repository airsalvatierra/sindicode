...
from socios.models import Region, Comuna
...
print('populating regiones')

for r in regiones:
    region = Region.objects.get_or_create(num_region=r[0],region=r[1],cod_iso=r[2],user_creacion='167458262')

print('populating regiones completed')
...
# ]
#
# print('populating ciudades')
#
# for c in ciudades:
#     r = Region.objects.get_or_create(pk=c[2])
#     # print(r[0])
#     ciudad = Ciudad.objects.get_or_create(ciudad=c[1],region=r[0],user_creacion='167458262')
#
# print('populating ciudades completed')
...
print('populating comunas')

for c in comunas:
    r = Region.objects.get(num_region=c[2])
    # print(r[0])
    comuna = Comuna.objects.get_or_create(comuna=c[1],region=r,user_creacion='167458262')

print('populating comunas completed')
